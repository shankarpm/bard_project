...
function onOpen() {
  ...
  var menuItems = [
    {name: 'Write table data to a sheet', functionName: 'connectToWaveFinancialData'}
  ];
  spreadsheet.addMenu('Wave Financial Data', menuItems);
}
 ...
 */
function connectToWaveFinancialData() {
  ...
  //write rows of Wave Financial data to the sheet
